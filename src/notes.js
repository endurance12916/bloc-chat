...
// 12. use {...this.props} when passing props from containers to components. The this.props refers to all the props passed into the container through the connect function
// 13. regarding defaultState in createStore:
...
// 14. to deploy firebase, run >npm run build and change to "public": "build" in firebase.json
// 15. Provider provides context - {store: this.props.store} to its children by rendering this.props.children