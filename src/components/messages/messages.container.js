...
import { subscribeToMessages, addMessage, updateCurrentMessage } from '../shared/activeRoom.actions';
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({subscribeToMessages, addMessage, updateCurrentMessage}, dispatch)
}
